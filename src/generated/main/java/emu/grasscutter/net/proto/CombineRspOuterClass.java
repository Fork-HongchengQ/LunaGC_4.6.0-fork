...
public final class CombineRspOuterClass {
  ...
  public interface CombineRspOrBuilder extends
     ...
     * </pre>
     *
     * <code>repeated .ItemParam total_return_item_list = 3;</code>
     */
    java.util.List<emu.grasscutter.net.proto.ItemParamOuterClass.ItemParam> 
     ...
     * </pre>
     *
     * <code>repeated .ItemParam uk10 = 9;</code>
     */
    java.util.List<emu.grasscutter.net.proto.ItemParamOuterClass.ItemParam> 
        getUk10List();
    /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int TOTAL_RETURN_ITEM_LIST_FIELD_NUMBER = 3;
    ...
    public static final int UK10_FIELD_NUMBER = 9;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < totalReturnItemList_.size(); i++) {
        output.writeMessage(3, totalReturnItemList_.get(i));
      }
      ...
      for (int i = 0; i < uk10_.size(); i++) {
        output.writeMessage(9, uk10_.get(i));
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < totalReturnItemList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, totalReturnItemList_.get(i));
      }
      for (int i = 0; i < totalRandomItemList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
      ...
      for (int i = 0; i < uk10_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(9, uk10_.get(i));
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "mParam\022*\n\026total_return_item_list\030\003 \003(\0132\n" +
      ".ItemParam\022\'\n\023totalRandomItemList\030\004 \003(\0132" +
      "\n.ItemParam\022\025\n\rcombine_count\030\005 \001(\r\022\030\n\004uk" +
      "10\030\t \003(\0132\n.ItemParam\022\017\n\007retcode\030\n \001(\005\022\022\n" +
      "\ncombine_id\030\013 \001(\r\022$\n\020result_item_list\030\016 " +
    ...
    internal_static_CombineRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_CombineRsp_descriptor,
        new java.lang.String[] { "TotalExtraItemList", "CostItemList", "TotalReturnItemList", "TotalRandomItemList", "CombineCount", "Uk10", "Retcode", "CombineId", "ResultItemList", "AvatarGuid", });
    emu.grasscutter.net.proto.ItemParamOuterClass.getDescriptor();
  }
